...
#include "/home/fjj/documents/project_code/src/imgpcl/include/imgpcl/auto_tchar.h"
// time synchronize
...
#include <time.h>
//#include "/home/fjj/documents/project_code/src/imgpcl/include/imgpcl/objectDetect.hpp"
using namespace cv;
using namespace std;
...
/// 全局变量
String face_cascade_name = "/home/fjj/documents/project_code/src/imgpcl/haarcascade_frontalface_alt.xml"; 
...
bool faceRec(Mat frame, Rect &faceRect)
{
	...
	if(detect_begin=="wave")
	{
		...
		stringstream sss;        
		string strs;      
		strs="/home/fjj/documents/project_code/src/imgpcl/wave_person";    
		sss.clear();        
		sss<<strs;              
		sss<<".jpg";        
		sss>>strs;
