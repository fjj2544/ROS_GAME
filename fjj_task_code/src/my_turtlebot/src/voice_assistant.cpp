...
#include "my_turtlebot/qtts.h"
#include "my_turtlebot/msp_cmn.h"
#include "my_turtlebot/msp_errors.h"
...
{
	int         ret                  = MSP_SUCCESS;
	const char* login_params         = "appid = 5c9ee709, work_dir = .";//登录参数,appid与msc库绑定,请勿随意改动
	/*
	* rdn:           合成音频数字发音方式
	* volume:        合成音频的音量
	* pitch:         合成音频的音调
