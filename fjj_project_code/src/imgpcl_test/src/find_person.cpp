...
#include <sstream>    
#include <stdio.h>
#include"imgpcl_test/auto_tchar.h"
...
String face_cascade_name = "$(find imgpcl_test)/haarcascade_frontalface_alt.xml";  
...
void image_process(Mat inImg)    
{
	...
	imwrite("$(find imgpcl_test)/person.jpg",inImg);//保存图片    
